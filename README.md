...
â [Easy to Setup](#-installation--setup)  
â [37 Themes](#themes)  
â [Google Analytics](#google-analytics)  
â [Hotjar](#hotjar)  
â [SEO](#seo)  
â [PWA](#pwa)  
â [Avatar and Bio](#avatar-and-bio)  
â [Social Links](#social-links)  
â [Skill Section](#skills)  
â [Experience Section](#experience)  
â [Certification Section](#certifications)  
â [Education Section](#education)  
â [Projects Section](#projects)  
â [Publication Section](#publications)  
â [Blog Posts Section](#blog-posts)
...
Your portfolio website will be live shortly. Any time you commit a change to the **main** branch, the website will be automatically updated. If you face any issue viewing the website, double-check the `base` value in the `gitprofile.config.ts` file. Also, check if **Source** is set to **GitHub Actions** in **Settings** â **Pages** â **Build and deployment**.

If you wish to add a custom domain, no CNAME file is required. Just add it to your repo's **Settings** â **Pages** â **Custom domain**.
